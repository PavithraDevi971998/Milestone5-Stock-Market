...
<body>
	...
	<div class="bord">
		...
		<form:form method="POST" action="/addstockExchange" modelAttribute="se1"><br><br>
			<table id="#table1 ">
		
			<tr>
				<th>Stock ExchangeId</th>
				<td><form:input path="stockexchangeid" type="text" />
				<br>
			...
			<tr>
				...
				<td><form:input path="stockexchangename" type="text" />
				<br>
				<form:errors path="stockexchangename" class="text-danger" /></td></tr>
			
			<tr>
				<th>Brief:</th>
				<td><form:input path="brief" type="text" />
				<br>
