...
<div class="container">
       ...
       %>
           ...
           <tr>
                           ...
                           <a href="update?companyCode=<%= e.getCompanyCode() %>"><input type="submit" value="update"></a></p></td>
                           <td><p class="col-md-2 ptext">
                           <a href="delete?companyCode=<%= e.getCompanyCode() %>"><input type="submit" value="delete"></a></p></td>
                           </tr>
                           <% }%>
                           </table>
                     </section> 
